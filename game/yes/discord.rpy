...
init -950 python in discord:
    ...
    class DiscordRPC(NoRollback):
        ...
        def set_defaults(self):
            ...
            self.large_text  = "DDLC: Just Natsuki"  # Uses the name of the mod defined in-game.
            ...
            # a players' status.
            self.small_text = "I'm really coding" #config.version  # Uses the version name of the mod
...
init -940 python:
    ...
    RPC = discord.DiscordRPC("981551181589512273")
